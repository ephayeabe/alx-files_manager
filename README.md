...
- an synchronous function get that takes a string key as argument and returns the Redis value stored for this key
...
**1. MongoDB utils**
File: [utils/db.js](utils/db.js/) - [main.js](main.js/)
...
**9. Image Thumbnails**
File: [utils/](utils/) - [worker.js](worker.js/) - [controllers/FilesController.js](controllers/FilesController.js/)
